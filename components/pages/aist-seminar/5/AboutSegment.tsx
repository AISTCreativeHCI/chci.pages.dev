      ...
      ja ? (
        <>
          <p>
            ...
            から開催します。 形式は、Zoom
            Webinarでのオンラインストリーミングをご覧いただくオンラインのワークショップとなります。第五回は「芸術表現のための創造性支援ツール」がテーマで、芸術表現、とくに音楽や映像を制作するためのプログラマブルなツールの研究開発に取り組まれてきた三名をお呼びして、招待講演とパネルセッションをしていただきます。
          </p>
          <p>
            なお、本セミナーは11月25日（土）{" "}
