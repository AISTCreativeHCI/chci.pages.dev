      ...
      bios={[
        <>
          ...
          <p>
            ...
            system designs. Her long-term research goal is to make communication
        ...
        <>
          ...
          <p>
            Xingyu "Bruce" Liu is a Ph.D. student at the UCLA HCI lab advised by
            Professor Xiang 'Anthony' Chen. His research explores Human-Computer
            Interaction in multimodal contexts. During the first three years of
            his Ph.D., Bruce has designed and developed human-AI systems in
            three application domains: making visual content accessible to
            non-visual users, and supporting and augmenting interpersonal
            communication.
          </p>
          <p>
