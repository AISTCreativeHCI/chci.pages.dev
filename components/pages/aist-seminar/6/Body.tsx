...
export const Body: FC = () => {
  ...
  const site = ja
    ? {
        ...origSite,
        title: "AIST Creative HCI Seminar #6",
        translatedTitle: "第六回 AIST Creative HCI Seminar",
        description:
          'このサイトでは第六回 AIST Creative HCI Seminarの紹介を掲載しています。第六回は「"In the wild" なHCI研究」がテーマで、芸術家や産業界などの「現場 (in the wild)」を志向する研究アプローチを採用し、論文だけに終わらない研究開発に取り組まれてきた二名をお呼びして、招待講演とパネルセッションを行いました。',
    ...
    : {
        ...
        description:
          'This website provides the archived video and introduction of the AIST Creative HCI Seminar #6, held to discuss HCI research "in the wild." It invited two researchers: Jennifer Jacobs and Koya Narumi, who share a research approach of conducting research in close collaboration with practitioners and industry.',
        image: "/images/5-hero.jpg",
      };
  return (
    <>
